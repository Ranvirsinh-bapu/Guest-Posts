...
function guest_post_form_shortcode() {
  ...
  <form id="guest-post-form" method="post">
    ...
    <input type="text" id="gp_title" name="gp_title" class="gp-input" ><br>
</div>
</div>
<div class="content-wrap">
    ...
    <textarea id="gp_content" name="gp_content" class="gp-textarea" ></textarea><br>
</div>
</div>
<div class="author-wrap">
    ...
    <input type="text" id="gp_author" name="gp_author" class="gp-input" ><br>
</div>
</div>
<div class="email-wrap">
    ...
    <input type="email" id="gp_email" name="gp_email" class="gp-input" ><br>
    </div>
    </div>
